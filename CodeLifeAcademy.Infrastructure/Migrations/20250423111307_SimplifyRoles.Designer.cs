...
namespace CodeLifeAcademy.Infrastructure.Migrations
{
    ...
    [Migration("20250423111307_SimplifyRoles")]
    partial class SimplifyRoles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoleUser", b =>
                {
                    b.HasOne("CodeLifeAcademy.Core.Entities.Role", null)
                        .WithMany()
                        .HasForeignKey("RolesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CodeLifeAcademy.Core.Entities.User", null)
                        .WithMany()
